...
// paly_btn클릭시 시간을 다시 생성하여 자동으로 움직이게 함.
play_btn.addEventListener('click', function(e){ //e=event 객체
  ...
  e.preventDefault(); //이벤트가 중복현상을 제거해줌
});
